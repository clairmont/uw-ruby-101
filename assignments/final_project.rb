...
#  ---------------------------------------------------------------------------------------
# Final Project available https://github.com/clairmont/Game-Of-Life
# Final Project .gifv example of running game: https://gfycat.com/FatalThoseHorse
# Notes:
# This project works best as three seperate .rb files that can be invoked via console command:
# rub (file).rb

# This project's render requires the gem 'gosu'; I attempted to make a proper Gemfile that loads the library, 
# If that doesn't work, manually install gosu via: gem install gosu
# If you run into issues, http://www.libgosu.org/ 
